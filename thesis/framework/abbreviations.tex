...
\begin{acronym}[LoRaWAN]
    ...
    \acro{LoRaWAN}{\ac{LoRa} Wide Area Network}
    \acro{LoS}{Line of Sight}
    \acro{LPWAN}{Low Power \ac{WAN}}
    \acrodefplural{LPWAN}{Low Power \acp{WAN}}
    ...
    \acro{TTNL}{\ac{TTN} Locator}
    \acro{TTNM}{\ac{TTN} Mapper}
    \acro{TTS}{The Things Stack}
    \acro{UDP}{User Datagram Protocol}
    \acro{UI}{User Interface}
    \acro{URL}{Uniform Resource Locator}
    \acro{UWB}{Ultra Wideband}
    \acro{VDOP}{Vertical \ac{DOP}}
