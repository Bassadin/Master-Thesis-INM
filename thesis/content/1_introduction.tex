...
The \ac{GHB} netadmins, who spent several hours helping me to install hardware in the building infrastructure they manage as well as configuring the external access for some gateways.
...
Odin Jäger, owner of the \ac{HFU} O building, for providing me with the opportunity to install a gateway on top of that building.

Martin Kramer, for configuring the network I used for the gateways as well as connecting them to the \ac{HFU} network infrastructure.