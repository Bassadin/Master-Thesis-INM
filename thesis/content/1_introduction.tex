...
\cite{mackey_lora-based_2019}~used some \ac{LoRa} gateways over relatively short distances to geolocate \ac{LoRa} devices by using their signal strength \ac{RSSI} values.
In another example,~\cite{lam_new_2018} proposed a method to geolocate \ac{LoRa} devices using a new kind of algorithm that is also based on \ac{RSSI} values.
