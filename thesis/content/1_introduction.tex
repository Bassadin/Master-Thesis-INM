...
Using available \ac{LoRa} Gateways that are registered in \acf{TTN} as well as placing new ones in the vicinity of the \acf{HFU}, this thesis aims to analyze and compare \ac{GPS}-less methods to geolocate off-the-shelf \ac{LoRaWAN} nodes without modifying them or the gateways used.
...
The Netzint GmbH in Gütenbach and Mr. Tom Lehmann in specific, for describing the implementation of \ac{LoRaWAN} technology into a company's infrastructure in Furtwangen to me as well as establishing connections to Mr. Odin Jäger who allowed me to pu up a gateway on the \ac{HFU} O building.
