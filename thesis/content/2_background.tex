...
In order to show the relevance of using \ac{RSSI} values over \ac{GNSS} systems to locate end devices, this chapter will give a brief comparison of power consumption between the two.
