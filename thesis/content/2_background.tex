...
\subsection{\acs{LoRaWAN} network architecture — connecting \aclp{AS}, gateways and \aclp{ED}}
...
Downlinks, on the other hand, are only sent from the \ac{LNS} to the \acl{ED} using a single \acl{LRWGW}~\cite[p. 12]{lora_alliance_inc_lorawan_specification_2017}.
