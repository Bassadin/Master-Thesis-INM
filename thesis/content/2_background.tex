...
This section aims to provide a general overview of wireless communication terminology and other principles necessary to understand the more hardware-oriented part of this thesis.
...
Deployments in remote or particularly large areas may require long-range protocols.
Likewise, sensors that are deployed in such areas may be hard to reach or placed apart by several hundred meters.
This makes low-power sensors that run on batteries for several years a necessity, as battery replacement can be expensive or even impossible.
...
The \acl{RSSI} is a measure of the strength of a wireless signal received by a device.
...
\begin{figure}[htbp]
    ...
    \caption{
        Example for different kinds of \acf{MPP} effects of \ac{RF} waves.
