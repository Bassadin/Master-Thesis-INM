...
\ac{RSSI} values can only function reliably when there is nothing blocking the signal between the transmitting and receiving stations, e.g.,\ if there is a \ac{LoS} between the sender and receiver.
...
\begin{figure}
    ...
    \caption{
        Comparison of \acp{SF} \ac{SF}7 to \ac{SF} 12 in the time and frequency dimensions.
        The doubling of the transmission time between \acp{SF} can be seen.\protect\cite{sakshama_ghoslya_lora_2017}
