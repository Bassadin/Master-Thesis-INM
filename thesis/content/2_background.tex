...
This \ac{E2EE} also makes \ac{LoRaWAN} packets secure against replay attacks, since a so-called \ac{MIC} is determined from the frame data, which in turn contains a \emph{DevNonce}, that is incremented with each packet sent~\cite{lora_alliance_inc_lorawan_2017-1}.
