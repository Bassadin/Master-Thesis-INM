...
It uses a set of known device locations with their corresponding \ac{RSS} values to locate devices based on the \ac{RSS} values it receives from the surrounding receivers --- \aclp{LRWGW}, in this case.
