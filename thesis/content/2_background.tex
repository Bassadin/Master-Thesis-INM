...
\begin{figure}[h]
    ...
    \caption{\ac{LoRaWAN} logo~\protect\cite{alliance_francais_2022}}
\end{figure}
...
While, officially, it is called \emph{The Things Stack Community Edition} since 2021, it is still commonly referred to as \acf{TTN}~\cite{the_things_network_what_nodate}.
...
\begin{figure}[h]
    ...
    \caption{\ac{LoRaWAN} Device class C communication schema~\protect\cite{semtech_lora_developer_portal_lora_2022}}\label{pic:lora-basics-station-schema}
\end{figure}
