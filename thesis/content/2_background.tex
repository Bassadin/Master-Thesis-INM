...
\subsection{Authentication in the \ac{LoRaWAN} network}
...
The Semtech UDP Packet Forwarder is a piece of software used to connect \ac{LoRa} gateways to the \ac{LNS}~\cite{the_things_network_semtech_nodate}.

\subsubsection{\acf{TCP} / LoRa Basics\texttrademark~Station}

Since \ac{TTN} v3, \ac{TTN} recommends using the \ac{TCP}-based LoRa Basics\texttrademark~Station protocol to connect gateways to the \ac{LNS}~\cite{the_things_network_semtech_nodate}.
...
% list the gateways that were used
