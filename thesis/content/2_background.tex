...
% TODO
% SNR = Signal-to-Noise Ratio = PR/PN. A low SNR indicates a noisy signal.

\section{Terminology: \acs{LoRa} vs. \acs{LoRaWAN}}

% Explain the difference between LoRa and LoRaWAN

\section{\acf{LoRa} modulation}

% explain the basics of LoRa with things like modulation, spreading factor, bandwidth, coding rate, channels etc.
...
% exaplain context of signal propagation and how it is affected by the environment
...
% Use https://dramco.be/tools/lora-calculator/ to give another example of battery life
...
% TODO: Add a conclusion about device classes here
...
% Explain lateration and compare to triangulation (term confusion)
...
% TODO explain the needed accuracy of timestamps for this to work
...
\acf{MPP} cause the \ac{RSSI} values to fluctuate even when the distance between the sender and receiver does not change.
This is because the signal can be reflected, diffracted, refracted and scattered and therefore take several paths (hence the term \ac{MPP}).

\subsubsection{Fingerprinting}

% explain context of location fingerprinting (maybe get some sources too)
...
% explain why it is important for the thesis, providing data, etc.