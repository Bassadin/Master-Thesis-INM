...
\aclp{SF} are important for this thesis because they interact with the \ac{RSSI} and \ac{SNR} values of a transmission.
...
\subsubsection{\acf{LPWAN}}

% TODO Specifiy what a LPWAN is

While common \acp{WAN}, such as the Internet, usually have a high bandwidth and low latency, \acp{LPWAN} are designed to have ``low duty cycles, very low data rates, relatively longer latencies, low power consumption, and coverage over several kilometers''~\cite[p. 289]{kumar_connecting_2023}.

% TODO write more, maybe an image for the structure?
