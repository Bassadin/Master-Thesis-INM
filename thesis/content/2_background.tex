...
% TODO mention relevance for this thesis
...
A specific case of multilateration is \emph{trilateration}, which specifies three receivers to get the ranges from.
...
\subsubsection{\acs{RSSI} Fingerprinting}\label{sec:rssi-fingerprinting}
