...
Since the frequency band used for \ac{LoRa} is unlicensed, it is possible that other devices use the same frequency band.
...
In the \ac{EU}, it uses the \SI{868}{\mega\hertz} frequency band.
...
In the \ac{EU} region, the duty cycle for transmissions in the \SI{868}{\mega\hertz} band is limited to 1\%~\cite[p. 29]{etsi_etsi_2012}.
