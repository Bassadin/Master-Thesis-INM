...
\begin{figure}[htbp]
    ...
    \caption[Screenshot of a \acl{TTNM} map showing data points taken from the \acl{LRWGW} deployed on the roof of the \emph{DL0FIS} clubhouse]{
...
\begin{figure}[htbp]
    ...
    \caption[\acl{LoS} between the \emph{DL0FIS} clubhouse and the Furtwangen city center]{
...
Upon further investigation, it was discovered that the gateway was situated on the factory building roof of \emph{E. Wehrle GmbH}, a company located in the eastern region of Furtwangen.
...
One of the \aclp{LRWED} ordered as part of this thesis is a \emph{Milesight EM310-UDL}, an ultrasonic distance/level sensor.
