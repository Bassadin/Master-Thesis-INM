...
To avoid having to do this importing of data regularly, the \ac{TTNL} backend includes a cronjob-like periodically executed task that automatically imports data from \ac{TTNM} every 24 hours.
