...
This was only done for gateways that had more than 500 ttnMapperDatapoints in the \ac{DB} to avoid outliers skewing the results as seen in \cref{fig:rssi-range-graph-negative-example}.
