...
\subsubsection{\acf{OSM}}

\textcolor{red}{<--- WIP --->}

% TODO write about OSM
...
% TODO should this go into conclusion?

Additionally, data points with varying \acp{SF} were used to plot the graphs.
...
\subsubsection{Adding \acf{SNR} to fingerprinting}
...
Since \ac{TTN} captures \ac{SNR} and \ac{SF} with each forwarded package anyway, this didn't affect the diffficulty of data collection.
