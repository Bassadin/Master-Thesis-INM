...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        ...
        \caption[Antenna installed on the roof of the clubhouse of the \emph{DL0FIS} amateur radio club]{
...
\begin{figure}[htbp]
    ...
    \caption[Screenshot of the \emph{Docker Desktop} application that shows the running containers of the \acl{TTNL} application]{
