...
The data flow starts with the \ac{LoRaWAN} \aclp{ED} on the right that collect \ac{GPS} data and send it to the \ac{LoRaWAN} gateways using the \ac{LoRaWAN} protocol.
...
This section will describe the different approaches that were taken to locate \ac{LoRaWAN} devices in this thesis.
