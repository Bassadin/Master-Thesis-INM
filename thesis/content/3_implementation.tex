...
``Unopinionated'' means that it does not enforce any particular way of implementing a web application and instead focuses on the premise of ``configuration over convention'', leaving it up to the developer to decide how to implement the specifics of the application~\cite{mardan_pro_2014}.
