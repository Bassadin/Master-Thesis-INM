...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{pictures/hardware/gps-nodes/ELV-LW-GPS1.jpg}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{pictures/ttn-mapper/ttnmapper_heatmap_before.png}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{pictures/ttn-locator/program_structure.png}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{pictures/ttn-locator/docker_desktop.png}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{pictures/ttn-locator/backend/prisma-erd.eps}
    \caption{
...
% TODO: Did this make the results any better?
...
\Cref{subsec:conclusion-toa-tdoa} will explain why this is the case and how it could be fixed.
